...
namespace BasketBall_LiveScore.Migrations
{
    ...
    [Migration("20241230233248_MatchAndRelationshipsUpdate")]
    partial class MatchAndRelationshipsUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MatchUser", b =>
                {
                    ...
                    b.Property<Guid>("PlayEncodersId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("MatchId", "PlayEncodersId");

                    b.HasIndex("PlayEncodersId");
            ...
            modelBuilder.Entity("BasketBall_LiveScore.Models.Match", b =>
                {
                    ...
                    b.HasOne("BasketBall_LiveScore.Models.Team", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("MatchUser", b =>
                {
                    ...
                    b.HasOne("BasketBall_LiveScore.Models.User", null)
                        .WithMany()
                        .HasForeignKey("PlayEncodersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
